        ...
        <div class="container-fluid">
            <div class="navbar-header">
                <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navcol-1">
                    ...
                    <span class="icon-bar"></span>
                    <span class="icon-bar"></span>
                </button><a class="navbar-brand navbar-link" target="_blank"><strong>Dissaster</strong> </a></div>
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="nav navbar-nav">
                    <li role="presentation"><a href="#"><strong>News</strong> </a></li>
                    <li role="presentation"></li>
                    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false" href="#"><strong>About </strong></a>
                    ...
                    <li role="presentation"><a href="#"><strong>Sign-In</strong> </a></li>
                </ul>
            </div>
        </div>
    </nav>
...
<?php
    ...
    if (isset($_POST['submit'])) 
        { 
            ...
            $sql = sprintf("INSERT INTO users (firstName, lastName, email, password) VALUES ('%s', '%s', '%s', '%s', 1)", mysqli_real_escape_string($db, $email), mysqli_real_escape_string($db, $password)); 
            mysqli_query($db, $sql);
            mysqli_close($db); 
